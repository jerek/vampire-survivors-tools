...
VST.VS.Weapon = new function () {
    ...
    const DLC_WEAPONS = {
        [VS.DLC_LEGACY_OF_THE_MOONSPELL]: [
            {id: VS.WEAPON_ID_SILVER_WIND,     vsId: 'SILVERWIND'},
            {id: VS.WEAPON_ID_FESTIVE_WINDS,   vsId: 'SILVERWIND2'},
            {id: VS.WEAPON_ID_FOUR_SEASONS,    vsId: 'FOURSEASONS'},
            {id: VS.WEAPON_ID_GODAI_SHUFFLE,   vsId: 'FOURSEASONS2'},
            {id: VS.WEAPON_ID_SUMMON_NIGHT,    vsId: 'SUMMONNIGHT'},
            {id: VS.WEAPON_ID_NIGHTS_REACH,    vsId: 'SUMMONNIGHT2'},
            {id: VS.WEAPON_ID_MIRAGE_ROBE,     vsId: 'MIRAGEROBE'},
            {id: VS.WEAPON_ID_JODORE,          vsId: 'MIRAGEROBE2'},
            {id: VS.WEAPON_ID_NIGHT_SWORD,     vsId: 'NIGHTSWORD'},
            {id: VS.WEAPON_ID_MURAMASA,        vsId: 'NIGHTSWORD2'},
            {id: VS.WEAPON_ID_MILLE_BOLLE_BLU, vsId: 'BUBBLES'},
            {id: VS.WEAPON_ID_BOO_ROO_BOOLLE,  vsId: 'BUBBLES2'},
            {id: VS.WEAPON_ID_BOCCE,           vsId: 'BOCCE'},
        ],
        [VS.DLC_TIDES_OF_THE_FOSCARI]: [
            {id: VS.WEAPON_ID_SPELL_STRING,      vsId: "SPELL_STRING"},
            {id: VS.WEAPON_ID_SPELL_STREAM,      vsId: "SPELL_STREAM"},
            {id: VS.WEAPON_ID_SPELL_STRIKE,      vsId: "SPELL_STRIKE"},
            {id: VS.WEAPON_ID_SPELL_STROM,       vsId: "SPELL_STROM"},
            {id: VS.WEAPON_ID_ESKIZZIBUR,        vsId: "SWORD"},
            {id: VS.WEAPON_ID_LEGIONNAIRE,       vsId: "SWORD2"},
            {id: VS.WEAPON_ID_FLASH_ARROW,       vsId: "FLASHARROW"},
            {id: VS.WEAPON_ID_MILLIONAIRE,       vsId: "FLASHARROW2"},
            {id: VS.WEAPON_ID_PRISMATIC_MISSILE, vsId: "PRISMATICMISS"},
            {id: VS.WEAPON_ID_LUMINAIRE,         vsId: "PRISMATICMISS2"},
            {id: VS.WEAPON_ID_SHADOW_SERVANT,    vsId: "SHADOWSERVANT"},
            {id: VS.WEAPON_ID_OPHION,            vsId: "SHADOWSERVANT2"},
            {id: VS.WEAPON_ID_PARTY_POPPER,      vsId: "PARTY"},
            // {id: ?,                              vsId: "INSATIABLE"},
        ],
    };
